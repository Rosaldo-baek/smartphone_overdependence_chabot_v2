...
def main():
    ...
    <div class="guide-box">
        ...
        <div class="guide-item">
            ...
            예) "숏폼과 과의존" → "숏폼 이용률에 따른 과의존 차이"<br>
            연속된 요청은 성능을 저하하는 원인이 될 수 있습니다. 대화 초기화를 통해 새롭게 세션을 구성하세요.
        </div>
        <div class="guide-item">
            <strong>주의:</strong> AI 답변에 <strong>오류(할루시네이션)</strong>가 있을 수 있습니다. <br>
            검색 결과를 바로 인용하지 마시고, <strong>원문을 통해 확인</strong>한 뒤 정보를 사용하십시오.
            <a href="https://www.nia.or.kr" target="_blank">NIA 홈페이지</a>에서 원문 확인 권장.
        </div>
    </div>
    """, unsafe_allow_html=True)
